module.exports = app => {
    ...
    router.get('/news/init', async (req, res) => {
        ...
        const newsTitles = ["周年庆QQ音乐专区上线，限免领取定制主题", "10月23日体验服停机更新公告", "王者四周岁庆典10.26开启 8大福利邀你来庆生", "周年狂欢不孤单 快手主播邀你瓜分亿万流量", "来，左边跟我一起变大龙，右边挂一个灯笼~", "斗鱼王者模拟战流派攻略大赛，分享你的棋圣之路", "千灯盛会如约而至 ，七城亮灯，与你共赏~"]
    ...
    router.get('/news/list', async (req, res) => {
        ...
        // 通过populate()函数，使你可以在一个文档中引用另一个集合中的文档，
        //  并将其填充到指定文档路径中。
        // const parent = await Category.findOne({
        //     name: '新闻资讯'
        // }).populate({
