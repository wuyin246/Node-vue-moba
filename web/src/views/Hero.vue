<template>
  <div class="page-hero" v-if="model">
    <div
      class="topbar bg-white py-2 px-3 d-flex ai-center text-white"
    ...
    >
      ...
      />
      <div class="px-2 flex-1 text-black">
        <span class="">MOBA</span>
        <span class="ml-2">STRATEGY</span>
      </div>
      <router-link tag="div" to="/" class="fs-xs text-black"
        >more heros &gt;</router-link
      >
    </div>
